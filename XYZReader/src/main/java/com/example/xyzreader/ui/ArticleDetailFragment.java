...
import com.example.xyzreader.ArticleExecutor;
...
public class ArticleDetailFragment extends Fragment implements
    ...
    private SubtitleCollapsingToolbarLayout mCollapsedToolbar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCollapsedToolbar = mRootView.findViewById(R.id.collapsing_toolbar_details);

        mToolbar = mRootView.findViewById(R.id.toolbar_details);

        recyclerView = mRootView.findViewById(R.id.recycler_details);
            ...
            if (mCursor != null) {
                ...
                if (!publishedDate.before(START_OF_EPOCH.getTime())) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        mCollapsedToolbar.setTitle(mCursor.getString(ArticleLoader.Query.TITLE));
    ...
    static class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemList = LayoutInflater.from(parent.getContext()).inflate(R.layout.adapter_paragraph_layout, parent, false);
        ...
        public static class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            public MyViewHolder(@NonNull View itemView) {
                ...
                mParagraph = itemView.findViewById(R.id.tv_paragraph);
            }
        }
    }
}
